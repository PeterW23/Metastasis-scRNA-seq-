...
FeaturePlot(cells, features = c('ADAM12', 'CDH11', 'CDH2', 'COL1A1', 'COL3A1', 'COL5A1')) # upregulated in cell adhesion and migration
FeaturePlot(cells, features = c('COL6A1', 'COL6A2', 'CTGF', 'CYP1B1', 'DLC1', 'FBLN1'))
FeaturePlot(cells, features = c('FBLN5', 'FGFR1', 'FN1', 'HAS2', 'LUM'))
...
FeaturePlot(cells, features = c('PTGER2', 'PTX3', 'SRGN', 'SULF1', 'SYNE1')) 
FeaturePlot(Cells, Features = c('TAGLN', 'TUBA1A', 'TUBA1A', 'VIM', 'ZEB1'))
...
FeaturePlot(cells, features = c('CDH1','CDH2','CDH11', 'ZEB1', 'CD44', 'PRRX1', 'DCN'))
FeaturePlot(cells, features = c('CDH2', 'CDH11', 'CDH1')) # migration and adhesion
FeaturePlot(cells, features = c('ZEB1', 'CD44', 'PRRX1')) # stem cell capabilities and colony initiation
FeaturePlot(cells, features = c('DCN', 'LOX')) # angiogenesis 
